  ...
  if (loading)
    return (
      <div className="mx-auto animate-spin p-10">
        <Avatar seed="Pandu AI Support agent" />
      </div>
    );
  ...
  return (
    <div className="px-0 md:p-10">
      <div className="md:sticky md:top-0 z-50 sm:max-w-sm ml-auto space-y-2 md:border p-5 rounded-b-lg md:rounded-lg bg-[#2991EE]">
        <h2 className="text-sm font-bold text-white">Link to Chat</h2>
        <p className="text-sm italic text-white">
          Share this link wit your customer to start conversations with your
          chatbot
        </p>
      ...
      <section className="relative mt-5 bg-white p-5 rounded-lg">
        ...
        <h2 className="text-xl font-bold mt-10">Heres what your AI khows</h2>
        <p>
          Your chatbot is equipped with following information to assist you in
        ...
        <div className="bg-gray-200 p-5 md:p-5 rounded-md mt-5">
          ...
          >
            <Input
              type="text"
              placeholder="Example: if customer ask for pirce, provide pricing page: www.example.com/pricing"
